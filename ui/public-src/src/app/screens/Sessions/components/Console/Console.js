...
class LogsList extends Component {
  ...
  getKey(log) {
    return `${log.sessionId}_${log.timestamp}_${JSON.stringify(log.message)}`;
  }
          ...
          <FilterControlPanel>
            <SessionsFilter>
              ...
              <FilterSelect
                ...
                renderValue={(value) => this.getSessionsFilterTextByIds(value)}
              >
              ...
              <FormControl>
                <FormGroup row>
                  ...
                  <TypeFilterLabel
                    control={
                      <TypeFilterCheckbox
                        checked={typeFilter.indexOf(LogTypes.payload) !== -1}
                        onChange={() => this.toggleTypeFilter(LogTypes.payload)}
                  ...
                  <TypeFilterLabel
                    control={
                      <TypeFilterCheckbox
                        checked={typeFilter.indexOf(LogTypes.error) !== -1}
                        onChange={() => this.toggleTypeFilter(LogTypes.error)}
